  ...
  template: `
    <div class="legal-container">
      ...
      <ul>
        ...
        <li><strong>Payment data</strong> — when you buy Starter, Plus, or Pro, Cashfree processes the card/UPI payment. Roomzo stores order identifiers, plan, amount, and credit balance — not your full card number.</li>
